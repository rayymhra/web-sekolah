    ...
    $redirect = '../logout.php'; // Halaman admin
    $redirect_message = 'Anda telah log out dan diarahkan ke halaman login...';
                    ...
                    <?php if (isset($_SESSION['id'])): ?>
                        <div class="d-flex ms-auto">
                            ...
                            <div class="navbar-user d-flex align-items-center">
                                <!-- Pastikan path gambar valid dan foto profil ada -->
                                <img src="<?php echo !empty($photo) ? $photo : '../uploads/default-profile.png'; ?>" alt="Foto Profil" style="width: 30px; height: 30px; border-radius: 50%; object-fit: cover;">
                                <span class="ms-2"><?php echo htmlspecialchars($username); ?></span>
                            </div>
                            <button id="logoutButton" class="btn btn-danger ms-3">Log Out</button>
                        </div>
                    <?php else: ?>
